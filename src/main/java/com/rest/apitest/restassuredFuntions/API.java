package com.rest.apitest.restassuredFuntions;
...
import com.rest.apitest.interfaces.IApi;
import com.rest.apitest.utilities.Helper;
...
public class API implements IApi {
    ...
    public void init(String url, String method) {
		this.url = url;
		switch(method)
		{
		   case "GET": 
			   this.method = HttpOperation.GET;
			   break;
		   case "POST":
			   this.method = HttpOperation.POST;
			   break;
		   case "PUT":
			   this.method = HttpOperation.PUT;
			   break;
		   case "PATCH":
			   this.method = HttpOperation.PATCH;
			   break;
		   case "DELETE":
			   this.method = HttpOperation.DELETE;
		    break;
		    default: this.method= null;
		}
		reqSpec = given();
	}
...
//			RestAssured.baseURI = getHelp.loadProperties(baseConst);
	...
	public API assertIt(String expected,ValidatorOperation operation) {
		
        switch(operation.toString())
        {
        		case "EQUALS_WITH_QUOTES":
        			resp.then().assertThat().body(equalTo('"'+expected+'"'));
        		break;
        		case "EQUALS":
        			resp.then().assertThat().body(equalTo(expected));
        		break;
